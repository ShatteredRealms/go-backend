...
var (
	...
	ErrCharacterNameToShort = fmt.Errorf("name must be at least %d characters", MinCharacterNameLength)

	// ErrCharacterNameToLong thrown when a character name is too long
	ErrCharacterNameToLong = fmt.Errorf("name can be at most %d characters", MaxCharacterNameLength)
)
...
type Character struct {
	...
	Location game.Location `gorm:"type:bytes;serializer:gob" json:"location"`
}
...
func (c *Character) ValidateGender() error {
	...
	return common.ErrInvalidGender
}
